...
# Credits
ui_print "Obrigado @Haxis, @Rafael Santos, @Markus328 e todos os
beta testers pela grande ajuda, sem vocês eu não sou nada <3"
ui_print "==================================================="
ui_print "[ Celulares : A10, A20, A30, A40 e A50            ]"
ui_print "[ Versão    : OpTX Ultra v3.6                     ]"
ui_print "[ Por       : @tiomt007, @Lowramm, @Drkf24M       ]"
ui_print "==================================================="
ui_print "[          PERFORMANCE E GAMING MODULO            ]"
ui_print "==================================================="
sleep 0.5
ui_print " "
ui_print "⣿⣿⣿⣿⣿⣿⣿⣿⣫⣾⢿⣮⡻⢃⣼⣿⣿⣿⡿⠟⠛⠛⠛⠛⠛⠛⠛⠻⠿⢿⣿⣿⣿"
